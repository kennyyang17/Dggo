...
function ButtonAppBar(props) {
  const { classes, handleLoginSubmit, loggedIn, signedUp, handleLogOut, handleSignUpSubmit } = props;
  return (
    <div className={classes.root}>
      <AppBar position="static">
        <Toolbar>
          ...
          {loggedIn ? <LogOut handleLogOut = {handleLogOut}/> : <SimpleModal handleLoginSubmit={handleLoginSubmit} loggedIn={loggedIn}/> }
          {signedUp ? null : <SignUpModal handleSignUpSubmit={handleSignUpSubmit} signedUp={signedUp}/> }  
